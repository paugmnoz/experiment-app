        ...
        return <section className="layers-management">
            ...
            <div className="mic-container">
                <span>
                    ...
                    {(taggingStore.comparedMicro1Activated && taggingStore.comparedMicro2Activated && taggingStore.comparedMicro3Activated && taggingStore.comparedMicro4Activated && taggingStore.comparedMicro5Activated && taggingStore.comparedMicro6Activated)
                        ? <button className="mic-cont-btn" onClick={() => taggingStore.activateMicro('all')}><img src="./assets/layers-manag-assets/eye-icon-green.svg" alt="" height="25" width="25"></img></button>
            ...
            <div className="mic-container">
                <span>
                    ...
                    {taggingStore.comparedMicro1Activated
                        ? <button className="mic-cont-btn"><img src="./assets/layers-manag-assets/eye-icon-green.svg" alt="" height="25" width="25"></img></button>
            ...
            <div className="mic-container">
                <span>
                    ...
                    {taggingStore.comparedMicro2Activated
                        ? <button className="mic-cont-btn" onClick={() => taggingStore.activateMicro('2')}><img src="./assets/layers-manag-assets/eye-icon-green.svg" alt="" height="25" width="25" ></img></button>
            ...
            <div className="mic-container">
                <span>
                    ...
                    {taggingStore.comparedMicro3Activated
                        ? <button className="mic-cont-btn" onClick={() => taggingStore.activateMicro('3')}><img src="./assets/layers-manag-assets/eye-icon-green.svg" alt="" height="25" width="25" ></img></button>
            ...
            <div className="mic-container">
                <span>
                    ...
                    {taggingStore.comparedMicro4Activated
                        ? <button className="mic-cont-btn" onClick={() => taggingStore.activateMicro('4')}><img src="./assets/layers-manag-assets/eye-icon-green.svg" alt="" height="25" width="25" ></img></button>
            ...
            <div className="mic-container">
                <span>
                    ...
                    {taggingStore.comparedMicro5Activated
                        ? <button className="mic-cont-btn" onClick={() => taggingStore.activateMicro('5')}><img src="./assets/layers-manag-assets/eye-icon-green.svg" alt="" height="25" width="25" ></img></button>
            ...
            <div className="mic-container">
                <span>
                    ...
                    {taggingStore.comparedMicro6Activated
                        ? <button className="mic-cont-btn" onClick={() => taggingStore.activateMicro('6')}><img src="./assets/layers-manag-assets/eye-icon-green.svg" alt="" height="25" width="25" ></img></button>
